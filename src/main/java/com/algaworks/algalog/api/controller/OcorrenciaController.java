...
import com.algaworks.algalog.domain.services.RegistroOcorrencia;
...
public class OcorrenciaController {
    ...
    public List<OcorrenciaModel> listarOcorrencias(@PathVariable Long entregaId) {
        ...
        return ocorrenciaAssembler.toCollectionModel(registroOcorrencia.listar(entregaId));
    }
    ...
    public OcorrenciaModel registrarOcorrencia(@PathVariable Long entregaId,@Valid @RequestBody OcorrenciaInput ocorrenciaInput) {
       ...
       return ocorrenciaAssembler.toModel(registroOcorrencia.registrar(entregaId, ocorrenciaInput.getDescricao()));
    }
